    ...
    return Padding(
      ...
      child: Container(
        ...
        child: ValueListenableBuilder<String>(
            valueListenable: Notifiers.getInstance().getNameNotifier(),
            builder: (context, userName, _) {
              return Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      padding: const EdgeInsets.fromLTRB(SIDE_PADDING * 0.75, 0,
                          SIDE_PADDING * 0.75, TOP_PADDING),
